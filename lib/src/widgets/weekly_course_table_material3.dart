...
/// - 學程課表
/// - 各班課表
class WeeklyCourseTableMaterial3 extends StatefulWidget {
  ...
  const WeeklyCourseTableMaterial3({
    super.key,
  ...
  @override
  State<WeeklyCourseTableMaterial3> createState() => _WeeklyCourseTableMaterial3State();
}
...
class _WeeklyCourseTableMaterial3State extends State<WeeklyCourseTableMaterial3> {
  // 緩存合併後的課程
  ...
  @override
  void didUpdateWidget(WeeklyCourseTableMaterial3 oldWidget) {
